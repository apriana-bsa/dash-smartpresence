      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="../{{ $data->id }}/edit" method="post" onsubmit="return validasi()">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<table width="480px">
					<tr>
						<td width=110px>{{ trans('all.nama') }}</td>
						<td>
							<input type="text" class="form-control" value="{{ $data->item }}" autofocus autocomplete="off" name="item" id="item" maxlength="200">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="float:left">
							<input type="text" class="form-control" value="{{ $data->satuan }}" autocomplete="off" name="satuan" id="satuan" maxlength="20">
						</td>
					</tr>
					<tr>
						<td>{{ trans('all.urutan') }}</td>
						<td style="float:left">
							<input type="text" class="form-control" value="{{ $data->urutan }}" onkeypress="return onlyNumber(0,event)" size="7" name="urutan" autocomplete="off" id="urutan" maxlength="3">
						</td>
					</tr>
					<tr>
						<td colspan=2>
