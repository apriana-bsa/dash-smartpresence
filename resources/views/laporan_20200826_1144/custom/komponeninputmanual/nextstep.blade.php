  ...
  <div class="wrapper wrapper-content animated fadeIn">
    <div class="row">
      <div class="ibox float-e-margins">
        ...
        <button type="button" id="kembali" class="btn btn-primary" onclick="ke('{{ url('laporan/custom/komponeninputmanual') }}')"><i class="fa fa-undo"></i>&nbsp;&nbsp;{{ trans('all.kembali') }}</button>&nbsp;&nbsp;
        <p></p>
              ...
              @if($datalaporankomponenmaster != '')
                @foreach($datalaporankomponenmaster as $key)
                  <tr>
                    ...
                    <td>
                      <center>
                        <a href="{{ url('laporan/custom/komponeninputmanual/'.$key->id.'/ubah') }}">{{ trans('all.ubah') }}</a>&nbsp;&nbsp;
  ...
  <script>
    function hapusData(id){
      alertConfirm('{{trans('all.apakahyakinakanmenghapusdataini')}}',
        function(){
          window.location.href="{{ url('laporan/custom/komponeninputmanual/') }}/"+id+'/hapus';
        }
      );
    }
