      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="../{{ $slideshow->id }}" method="post" onsubmit="return validasi()">
				...
				<table width="480px">
					<tr>
						...
						<td>
							<input type="text" class="form-control" value="{{ $slideshow->nama }}" autofocus autocomplete="off" name="nama" id="nama" maxlength="100">
						</td>
					</tr>
					<tr>
						...
						<td style="float:left">
							<table>
								<tr>
									<td style="padding:0">
										<input type="text" class="form-control" value="{{ $slideshow->timeout }}"  size="5" autocomplete="off" name="timeout" id="timeout" maxlength="5">
									</td>
					...
					<tr>
						...
						<td style="float:left">
							<table>
								<tr>
									<td style="padding:0">
										<input type="text" class="form-control" value="{{ $slideshow->durasiperslide }}" size="5" autocomplete="off" name="durasiperslide" id="durasiperslide" maxlength="5">
									</td>
									<td style="padding:0;padding-left:10px">{{ trans('all.detik') }}</td>
								</tr>
							</table>
					...
					<tr>
						...
						<td>
							<table width=100% id='tabWaktu'>
								<?php $i = $totalslideshowwaktu; ?>
								@if($totalslideshowwaktu != 0)
									@foreach($slideshowwaktu as $key)
										<tr id='addr_waktu{{ $i }}'>
											<td style=padding-left:0px;float:left>
												<input autocomplete='off' size="7" name='waktumulai[]' value="{{ $key->waktumulai }}" class='form-control jam waktumulai' placeholder='hh:mm' type='text' id='waktumulai_{{ $i }}'>
											</td>
											<td style=padding-left:0px;margin-top:6px;float:left>-</td>
											<td style=padding-left:0px;float:left>
												<input autocomplete='off' size="7" name='waktuselesai[]' value="{{ $key->waktuselesai }}" class='form-control jam waktuselesai' placeholder='hh:mm' type='text' id='waktuselesai_{{ $i }}'>
											</td>
											<td style=padding-left:0px;width:20px;float:left;>
