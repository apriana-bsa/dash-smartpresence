      ...
      <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins">
          <div class="ibox-content p-md">
              <form method="post" id='myform' action="{{ url('/pengaturan/formatsmsverifikasi') }}" onsubmit="return validasi()">
                {{ csrf_field() }}
                <table cellpadding="0" width='100%' cellspacing="0" border="0">
                  <tr>
                    <td>
                      <textarea name="formatsms" id="formatsms" rows="5" class="form-control">{{ $data->format_sms_verifikasi_lupa_pwd_pegawai }}</textarea>
                      <p></p>
                      ...
                      <p></p>
                      <b style='cursor:default' class='label pilihan' onclick='give("{verification_code}","formatsms")'>{verification_code}</b>&nbsp;: {{ trans('all.menyisipkankodeverifikasi') }}
                      <p></p>
