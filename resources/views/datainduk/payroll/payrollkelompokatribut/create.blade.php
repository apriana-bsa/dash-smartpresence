...
@section('content')
    ...
    function getAtributNilai() {
        ...
        if(atribut != '') {
            $.ajax({
                type: "GET",
                url: '{{ url('getatributnilai/combobox') }}/' + atribut,
                data: '',
                cache: false,
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('datainduk/payroll/payrollkelompok/'.$idpayrollkelompok.'/atribut') }}" method="post" onsubmit="return validasi()">
                {{ csrf_field() }}
                <table width="480px">
                    <tr>
