      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('laporan/custom/kelompok/'.$idlaporankelompok.'/komponenmaster') }}" method="post" onsubmit="return validasi()">
                    ...
                    <tr>
                        ...
                        <td style="float:left">
                            <select name="tipekolom" id="tipekolom" class="form-control">
                                <option value="satuan">{{ trans('all.satuan') }}</option>
                                @if($jenislaporankelompok == 'rekap')
                                    <option value="rangetanggal">{{ trans('all.rangetanggal') }}</option>
                                @endif
                            </select>
                        </td>
                    </tr>
