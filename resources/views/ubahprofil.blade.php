          ...
          <div class="ibox float-e-margins">
              ...
              <div>
                  <div class="ibox-content no-padding border-left-right">
                      <img alt="image" class="img-responsive" src="/back-end/foto/no-image.jpg">
                  </div>
                  <div class="ibox-content profile-content">
                      
                      <h4><strong>{{ $profil->nama }}</strong></h4>
                      ...
                      <div class="user-button">
                          <div class="row">
                              <div class="col-md-6">
                                  <button type="button" class="btn btn-primary"><i class="fa fa-key"></i> {{ trans('all.gantipassword') }}</button>
                              </div>
                              <div class="col-md-6">
