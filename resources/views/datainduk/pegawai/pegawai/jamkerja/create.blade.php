      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form id="formtambah" action="{{ url('datainduk/pegawai/pegawai/jamkerja/submittambah') }}" method="post" onsubmit="return validasi()" enctype="multipart/form-data">
                ...
                <table width="480px">
                    ...
                    <tr>
                        ...
                        <td style="float:left">
                            <input type="text" size="11" class="form-control date" autocomplete="off" name="berlakumulai" id="berlakumulai" maxlength="10" placeholder="dd/mm/yyyy">
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2>
