...
@section('content')
  ...
  function ekspor(jenis){
      var idpegawai = $('#buttonekspor').attr('idpegawai');
      window.location.href='{{ url('laporan/perpegawai') }}/'+jenis+'/'+idpegawai;
  }

  function detailRekapitulasi(idrekapabsen){
      callModalGeneral('{{ trans('all.rekapitulasi') }}','{{ url('laporanperpegawai/detailrekapitulasi') }}/'+idrekapabsen,'modal-lg');
  }
  </script>
  <style type="text/css">
  td{
      ...
      <div class="col-lg-12">
            ...
            <table width="100%">
              <tr>
                ...
                <td style="float:left;min-width:250px">
                    <select class="form-control" id="pegawai" name="pegawai"></select>
                </td>
                ...
                <td style="float:left;">
                  ...
                  <td style="display: none;float:right" id="buttonekspor" idpegawai="">
                    ...
                    <button type="button" class="btn btn-primary pull-right" onclick="return ekspor('excel')"><i class="fa fa-download"></i>&nbsp;&nbsp;{{ trans('all.ekspor') }}</button><p></p>
                    {{--  <div class="input-group" style="margin-bottom:10px"> 
                        <div class="input-group-prepend">
                            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button"><i class="fa fa-download"></i>&nbsp;&nbsp;{{ trans('all.ekspor') }}</button>
                            <ul class="dropdown-menu" style="left:-67px !important">
                                <li><a href="#" onclick="return ekspor('excel')">{{ trans('all.excel') }}</a></li>
