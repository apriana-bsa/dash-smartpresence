          ...
          @if(!isset($keterangan))
              <form action="{{ url('laporan/pekerjaanuser') }}" method="post" onsubmit="return validasi()">
                  ...
                  <table width="100%" id="jangkauantanggal" style="display: none;">
                      <tr>
                          <td style="width:50px;">{{ trans('all.tanggal') }}</td>
                          <td style="float:left">
                  ...
                  <table>
                      <tr>
                          <td style="width: 50px;">{{ trans('all.pegawai') }}</td>
                              ...
                              <script type="text/javascript">
                                  $(document).ready(function(){
                                      $("#pegawai").tokenInput("{{ url('tokenpegawai') }}", {
                                          theme: "facebook",
                                          prePopulate: [
                                              @if(Session::has('lappekerjaanuser_pegawai'))
                                                  <?php
                                                  $datapegawai = explode(',', Session::get('lappekerjaanuser_pegawai'));
