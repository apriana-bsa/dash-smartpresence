                        ...
                        @if(strpos(Session::get('hakakses_perusahaan')->atribut, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->penempatan, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->lokasi, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->pegawai, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->aturatributdanlokasi, 'u') !== false  || strpos(Session::get('hakakses_perusahaan')->aturatributdanlokasi, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->facesample, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->agama, 'l') !== false || strpos(Session::get('hakakses_perusahaan')->pekerjaan, 'l') !== false)
                          <li @if($menu == 'pegawai') class="active" @elseif($menu == 'aturatributdanlokasi') class="active" @elseif($menu == 'atributvariable') class="active" @elseif($menu == 'atribut') class="active" @elseif($menu == 'penempatan') class="active" @elseif($menu == 'lokasi') class="active" @elseif($menu == 'facesample') class="active" @elseif($menu == 'agama') class="active" @elseif($menu == 'pekerjaan') class="active" @elseif($menu == 'pekerjaankategori') class="active" @endif>
                            ...
                            <ul class="nav nav-third-level">
                              ...
                              @endif
                              @if(strpos(Session::get('hakakses_perusahaan')->penempatan, 'l') !== false)
                                <li @if($menu == 'penempatan') class="active" @endif><a href="{{ Session::get('perusahaan_expired') == 'tidak' ? url('datainduk/pegawai/penempatan') : "#" }}"><i class="fa fa-angle-double-right"></i>{{ trans('all.penempatan') }}</a></li>
                              @endif
          ...
          <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                @if(Session::has('conf_webperusahaan'))
                    ...
                    @endif
                @endif
                <li onclick="return loadHeaderContent('perusahaan','perusahaan_body')">
                        ...
                        @if(Session::has('conf_konfirmasi'))
                          @if(Session::get('conf_konfirmasi') > 0)
                            <li onclick="return loadHeaderContent('notif','notif_body')">
                              ...
                              <ul class="dropdown-menu dropdown-alerts dropdowngroups" id="notif_body" style='max-height:400px;min-width:360px;overflow: auto;'>
                              </ul>
                            </li>
                          @endif
                        @endif
                ...
                @if(Session::has('conf_webperusahaan'))
                    @if(Session::get('perusahaan_sisatrial') <= 14)
                        <li style="min-height:60px;" class="tes123">
