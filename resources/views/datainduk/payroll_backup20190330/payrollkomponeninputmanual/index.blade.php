            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="3" style="float:left">
                        ...
                        <button type="button" onclick="ke('payrollkomponeninputmanual/setulang')" class="btn btn-primary"><i class="fa fa-undo"></i>&nbsp;&nbsp;{{ trans('all.setulang') }}</button>&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
            @if(count($atributs) > 0)
                    ...
                    <div class="col-md-4">
                        ...
                        @foreach($atribut->atributnilai as $atributnilai)
                            @if(Session::has('payrollkomponeninputmanual_atribut'))
                                {{ $checked = false }}
                                @for($i=0;$i<count(Session::get('payrollkomponeninputmanual_atribut'));$i++)
                                    @if($atributnilai->id == Session::get('payrollkomponeninputmanual_atribut')[$i])
