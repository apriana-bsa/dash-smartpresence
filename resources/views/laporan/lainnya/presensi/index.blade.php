    ...
    <div class="row">
      <div class="col-lg-12">
          <ul class="nav nav-tabs">
            ...
            <li @if($jenis == 'belumabsenmasuk') class="active" @endif><a href="{{ url('laporan/lainnya/belumabsenmasuk') }}">{{ trans('all.belumabsenmasuk') }}</a></li>
            ...
            <li @if($jenis == 'masuktanpajadwal') class="active" @endif><a href="{{ url('laporan/lainnya/masuktanpajadwal') }}">{{ trans('all.masuktanpajadwal') }}</a></li>
              ...
              <form id="form1" method="post" action="" onsubmit="return validasi()">
                ...
                <table width="100%" id="tabelwaktu_{{ $jenis }}">
                  <tr>
                    ...
                    <td style="float: left;">
                      <button type="button" id="submit" onclick="return $('#tampilkan').trigger('click')" type="button" class="ladda-button btn btn-primary slide-left"><span class="label2"><i class='fa fa-check-circle'></i>&nbsp;&nbsp;{{ trans('all.tampilkan') }}</span> <span class="spinner"></span></button>&nbsp;&nbsp;
                      <button type="submit" id="tampilkan" style="display:none">{{ trans('all.tampilkan') }}</button>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="4">
              ...
              <div class="ibox-content">
                <table width=100% class="table datatable table-striped table-condensed table-hover">
                  ...
                  <tr>
                    ...
                    @if($jenis != 'belumabsenmasuk')
                        <td class="opsi5"><b>{{ trans('all.jammasuk') }}</b></td>
                    @endif
                    @if($jenis == 'pulangawal' || $jenis == 'terlambat')
                        @if($jenis == 'pulangawal')
                            <td class="opsi5"><b>{{ trans('all.jampulang') }}</b></td>
                        @endif
                        <td class="opsi5"><b>{{ trans('all.lamakerja') }}</b></td>
                        @if($tampilflexytime == 'y')
                            <td class="opsi5"><b>{{ trans('all.lamaflexytime') }}</b></td>
                        @endif
                        <td class="opsi5"><b>{{ trans('all.'.$jenis) }}</b></td>
                    @endif
