          ...
          <div class="tab-content">
            ...
            <div id="tab-3" class="tab-pane">
              <table>
                ...
                <tr>
                  <td colspan="2">
                    <button type="submit" name="tombol" value="perpegawai_excel" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;{{ trans('all.excel') }}</button>&nbsp;&nbsp;
                    <button type="submit" name="tombol" value="perpegawai_pdf" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;{{ trans('all.pdf') }}</button>
                  </td>
                </tr>
              </table>
            </div>
