      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="../{{ $batasanemail->id }}" method="post" onsubmit="return validasi()">
              ...
              <table width="480px">
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" value="{{ $batasanemail->email }}" autocomplete="off" name="email" id="email" maxlength="255">
                    </td>
                </tr>
                <tr>
                  ...
                  <td style="float: left;">
                    <select class="form-control" id="batasan" name="batasan">
                      @foreach($batasan as $key)
                        <option value="{{ $key->id }}" @if($batasanemail->idbatasan == $key->id) selected @endif>{{ $key->namabatasan }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
