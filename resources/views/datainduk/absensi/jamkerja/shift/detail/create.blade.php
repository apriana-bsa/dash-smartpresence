      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('datainduk/absensi/jamkerja/'.$idjamkerja.'/shift/'.$idjamkerjashift.'/detail') }}" method="post" onsubmit="return validasi()">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <table width="480px">
                    <tr>
                      <td width='150px'>{{ trans('all.berlakumulai') }}</td>
                      <td style='float:left'>
                        <input type='text' class='form-control date' autofocus autocomplete='off' id='berlakumulai' size='11' placeholder='dd/mm/yyyy' name='berlakumulai'>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table width='200px'>
                          <tr>
                            <td style='padding-left:0px;padding-top:0px;padding-bottom:0px'>
                              <input type='text' class='form-control jam' placeholder='hh:mm' id='jammasuk' name='jammasuk'>
                            </td>
                            ...
                            <td style='padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px'>
                              <input type='text' class='form-control jam' placeholder='hh:mm' id='jampulang' name='jampulang'>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <table width='200px'>
                          <tr>
                            <td style='padding-left:0px;padding-top:0px;padding-bottom:0px'>
                              <input type='text' class='form-control jam' placeholder='hh:mm' id='jamistirahatmulai' name='jamistirahatmulai'>
                            </td>
                            <td style='padding-left:0px;padding-top:0px;padding-bottom:0px'>-</td>
                            <td style='padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px'>
                              <input type='text' class='form-control jam' placeholder='hh:mm' id='jamistirahatselesai' name='jamistirahatselesai'>
                            </td>
                          </tr>
                        </table>
                      </td>
