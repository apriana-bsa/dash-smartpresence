...
@section('content')
    ...
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li>{{ trans('all.jenisjamkerjashift') }}</li>
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('datainduk/absensi/jamkerjashiftjenis') }}" method="post" onsubmit="return validasi()">
                ...
                <table width="480px">
                    ...
                    <tr>
                      <td colspan=2>
                        ...
                        <button type="button" id="kembali" onclick="return ke('../jamkerjashiftjenis')" class="btn btn-primary"><i class="fa fa-undo"></i>&nbsp;&nbsp;{{ trans('all.kembali') }}</button>
                      </td>
                    </tr>
                </table>
            </form>
