        ...
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="../{{ $hakakses->id }}" method="post" onsubmit="return validasi()">
                ...
                <table width="640px">
                    <tr>
                        <td width="230px">{{ trans('all.nama') }}</td>
                        <td>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <td style='padding-left:0px;'><input type='checkbox' onclick="switchmenucheckbox('penempatan','lihat')" @if(strpos($hakakses->penempatan, 'l') !== false) checked @endif value='l' name='penempatan_lihat' id='penempatan_lihat'></td>
                          <td><span class='penempatan_lihat' onclick="switchmenu('penempatan','lihat')">{{ trans('all.lihat') }}</span></td>
                          <td class='penempatan_manipulasi manipulasi'><input type='checkbox' @if(strpos($hakakses->penempatan, 't') !== false || strpos($hakakses->penempatan, 'm') !== false) checked @endif class='penempatan_manipulasi_checkbox' value='t' name='penempatan_tambah' id='penempatan_tambah'></td>
                          ...
                          <td class='penempatan_manipulasi manipulasi'><input type='checkbox' @if(strpos($hakakses->penempatan, 'u') !== false || strpos($hakakses->penempatan, 'm') !== false) checked @endif class='penempatan_manipulasi_checkbox' value='u' name='penempatan_ubah' id='penempatan_ubah'></td>
                          ...
                          <td class='penempatan_manipulasi manipulasi'><input type='checkbox' @if(strpos($hakakses->penempatan, 'h') !== false || strpos($hakakses->penempatan, 'm') !== false) checked @endif class='penempatan_manipulasi_checkbox' value='h' name='penempatan_hapus' id='penempatan_hapus'></td>
