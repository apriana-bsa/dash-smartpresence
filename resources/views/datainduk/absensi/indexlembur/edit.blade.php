			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<form action="../{{ $indexlembur->id }}" method="post" onsubmit="return validasi()">
							...
							<table width="100%">
								<tr>
									...
									<td style="float:left">
										<input type="text" size="50" class="form-control" autofocus value="{{ $indexlembur->nama }}" autocomplete="off" name="nama" id="nama" maxlength="100">
									</td>
								</tr>
								<tr>
									...
									<td style="float:left">
										<select class="form-control" name="jenishari">
											<option value="biasa" @if($indexlembur->jenishari == 'biasa') selected @endif>{{ trans('all.biasa') }}</option>
											<option value="hariminggu" @if($indexlembur->jenishari == 'hariminggu') selected @endif>{{ trans('all.hariminggu') }}</option>
											<option value="harilibur" @if($indexlembur->jenishari == 'harilibur') selected @endif>{{ trans('all.harilibur') }}</option>
										</select>
									</td>
								</tr>
								<tr>
									...
									<td style="float:left">
										<input type="text" size="11" class="form-control date" autocomplete="off" value="{{ $indexlembur->berlakumulai }}" name="berlakumulai" id="berlakumulai" maxlength="10" placeholder="dd/mm/yyyy">
									</td>
								</tr>
								<tr>
								...
								{{-- <tr>
                                    <td width=110px>{{ trans('all.indexlembur') }}</td>
                                    <td style="float:left">
                                        <input type="text" autofocus class="form-control" value="{{ $indexlembur->sampaidengan+0 }}" onkeypress="return onlyNumber(0,event)" size="7" name="sampaidengan" autocomplete="off" id="sampaidengan" maxlength="6">
                                    </td>
                                ...
                                <tr>
                                    <td>{{ trans('all.index') }}</td>
                                    <td style="float:left">
                                        <input type="text" class="form-control" value="{{ $indexlembur->index+0 }}" onkeypress="return onlyNumber(0,event)" size="7" name="index" autocomplete="off" id="index" maxlength="6">
                                    </td>
