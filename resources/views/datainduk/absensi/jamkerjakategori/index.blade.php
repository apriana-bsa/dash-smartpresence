  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><strong>{{ trans('all.kategorijamkerja') }}</strong></li>
      </ol>
    </div>
    <div class="col-lg-2">
    ...
    <div class="row">
      <div class="col-lg-12">
          <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="{{ url('datainduk/absensi/jamkerjakategori') }}">{{ trans('all.kategorijamkerja') }}</a></li>
          ...
          <table width="100%">
              <tr>
                  @if(strpos(Session::get('hakakses_perusahaan')->jamkerja, 't') !== false || strpos(Session::get('hakakses_perusahaan')->jamkerja, 'm') !== false)
                      <td>
                          <a href="jamkerjakategori/create" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;{{ trans('all.tambahdata') }}</a>
                      </td>
                  @endif
                  <td>
                      <button class="btn btn-primary pull-right" onclick="return ke('{{ url('jamkerjakategori/excel') }}')"><i class="fa fa-download"></i>&nbsp;&nbsp;{{ trans('all.ekspor') }}</button>
                  </td>
              </tr>
          </table>
          <p></p>
...
$(function() {
    $('.datatable').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: '{!! url("datainduk/absensi/jamkerjakategori/index-data") !!}',
            type: "POST",
