      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="../{{ $atributnilai->id }}" method="post" onsubmit="return validasi()">
				...
				<table width="480px">
					<tr>
						...
						<td>
							<input type="text" class="form-control" value="{{ $atributnilai->nilai }}" autofocus autocomplete="off" name="nilai" id="nilai" maxlength="100">
						</td>
					</tr>
					<tr>
						<td width="110px">{{ trans('all.kode') }}</td>
						<td style="float:left">
							<input type="text" size="25" class="form-control" value="{{ $atributnilai->kode }}" autocomplete="off" name="kode" id="kode" maxlength="20">
						</td>
					</tr>
					<tr>
						<td colspan=2>
