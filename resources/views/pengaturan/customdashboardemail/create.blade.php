...
@section('content')
	...
	function validasi(){
        ...
        var email = $("#email").val();
        var customdashboard = $("#customdashboard").val();
        ...
        if(customdashboard === ""){
            alertWarning("{{ trans('all.customdashboard').' '.trans('all.sa_kosong') }}",
                function() {
                    aktifkanTombol();
                    setFocus($('#customdashboard'));
                });
            return false;
        }
	}
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('pengaturan/customdashboardemail') }}" method="post" onsubmit="return validasi()">
