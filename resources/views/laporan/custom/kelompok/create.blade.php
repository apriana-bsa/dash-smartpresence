      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          <div class="ibox-content">
          	<form action="{{ url('laporan/custom/kelompok') }}" method="post" onsubmit="return validasi()" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="jenis" id="jenis" class="form-control">
                                <option value="rekap">{{trans('all.rekap')}}</option>
                                <option value="detail">{{trans('all.detail')}}</option>
                            </select>
                        </td>
                    </tr>
{{--                    <tr>--}}
